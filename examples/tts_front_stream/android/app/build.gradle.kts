...
android {
    namespace = "ai.thestage.qlip.tts_front_stream"
    compileSdk = 36
    // Pin the NDK the bundled plugins (jni / sonic / espeak-ng) build
    // against — silences the AGP "plugin requires NDK 28.2" warning.
    ndkVersion = "28.2.13676358"

    // Genie: optional extra jni dir (tarball unpack). The default
    // staging path used by scripts/setup.sh (QAIRT=…) is
    ...
    defaultConfig {
        applicationId = "com.example.tts_front_stream"
        minSdk = 28
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
