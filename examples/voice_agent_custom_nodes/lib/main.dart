    ...
    if (_apiToken.isEmpty) {
      setState(() {
        _initError =
            ...
            'Build with: '
            '--dart-define=TS_API_TOKEN=<token>';
      });
      return;
    }
    // OPENAI_API_KEY is optional: it is only needed for cloud-LLM
    // replies. The custom-node, VLM-caption and screen-recorder
    // demos run without it, so init proceeds either way.
    try {
